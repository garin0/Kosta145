...
/*			String subExt = orgFile[i].getName().substring(orgFile[i].getName().lastIndexOf(".")+1);
			if(subExt.equals(ext)){
				File move = new File(orgDir + File.separator + orgFile[i].getName());
				File destination = new File(destDir + File.separator + orgFile[i].getName());
