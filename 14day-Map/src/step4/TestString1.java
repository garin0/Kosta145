...
public class TestString1 {
	...
	public static void main(String[] args) {
		...
		System.out.println(name9.lastIndexOf(".")); // 마지막 . 인덱스 위치
		System.out.println(name9.indexOf(".")); // 첫번째 . 인덱스 위치
		String menu = "족발,순대,맥주,치킨,보쌈";
